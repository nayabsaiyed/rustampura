...
$faq_articles = array(
	...
	array(
		...
		<strong>Regenerate WooCommerce Thumbnails (WooCommerce 3.x)</strong>
		To regenerate only product thumbnails go to <a href="' . admin_url( 'admin.php?page=wc-status&tab=tools' ) . '"><strong>WooCommerce &gt; Status &gt; Tools</strong></a> and click <strong>Regenerate shop thumbnails</strong> button. The &quot;regeneration&quot; process will run in background and you should see changes as soon as the process is completed.
		',
...
$support_allowed = Kalium_Theme_License::license();
?>
<div class="wrap about-wrap">
	...
	<div class="kalium-help">
		...
		<div class="docs-and-support">
			...
			<p>In this page you can view general frequently asked questions to help you get started. For more, refer to our <a href="https://documentation.laborator.co/item/kalium/" target="_blank">documentation site</a> or click the links below:</p>
		
		
			<div class="docs-links clearfix">
				<a href="https://documentation.laborator.co/item/kalium" class="documentation-button" id="lab_read_docs" target="_blank">Read Documentation</a>
		...
		<ul class="kalium-faq-links">
			...
			<li class="more">
				<h3 class="kalium-faq-title">
					<a href="https://documentation.laborator.co/item/kalium/" target="_blank">See more articles</a>
				</h3>
			</li>
		</ul>
